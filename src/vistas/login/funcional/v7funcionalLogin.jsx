...
// src\vistas\clientes\tablero\TableroCLientes.jsx
...
function Login() {
  ...
  if (rol && rol.length > 0) {
      if (rol === "administrador") {
        return (<TableroAdministrador user={user}/>); // pasar el UID del usuario como prop
        //console.log("ya hay administrador");
      } else {
       //console.log("no hay administrador");
      }
    /*  if (rol === "cliente") {
        return (<TableroClientes />);
        //console.log("ya hay cliente");
      }*/
