...
// conexion ItemList ItemPlatillo
...
const ItemPlatillo = ({ item: { visibilidad, descripcion, referencia, id, name, description, price, img, volumen, genero, talla } }) => {
console.log('ItemPlatillo');
    ...
    return (
        <>
            {visibilidad === 'ACTIVO' ?
                <div className='divPricipalItem2' >
                    <div 
                        className='divTituloProducto'
