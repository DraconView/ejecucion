...
import ListaProductosDetallados from "./ListaProductosDetallados";
...
function ReciboVenta({ orderId }) {
  //console.log('llamando a ReciboVenta');
  ...
  useEffect(() => {
    if (
      ...
      setfecha(objetoFecha.toLocaleDateString('es-ES', opcionesFecha));
      const opcionesHora = { hour: '2-digit', minute: '2-digit' };
      const objetoHora = new Date(datosDeRespuesta.timestamp.toDate());
      sethora(objetoHora.toLocaleTimeString('es-ES', opcionesHora));
