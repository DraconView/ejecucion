...
function EditarDiasCalendario(parametro) {
  ...
  const editarRegistros = (esteDato) => {
    ...
    setinJoHora(esteDato.inJo[0]);
    setinJoMinutos(esteDato.inJo[1]);
    setfiJoHora(esteDato.fiJo[0]);
    setfiJoMinutos(esteDato.fiJo[1]);
    setinDeHora(esteDato.inDe[0]);
    setinDeMinutos(esteDato.inDe[1]);
    setfiDeHora(esteDato.fiDe[0]);
    setfiDeMinutos(esteDato.fiDe[1]);
              ...
              >
                ...
                {mapeado.horariosBloqueados.length > 0 ? (
                  mapeado.horariosBloqueados.map((horarioBloqueado) => (
                    <div key={index} className="divHorarioBloqueado">
