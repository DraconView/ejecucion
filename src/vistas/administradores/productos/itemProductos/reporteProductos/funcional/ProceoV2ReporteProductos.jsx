...
import ListaProductosDetallados from "./CartItemReporteProductos";
...
const ReporteProductos = () => {
    ...
    useEffect(() => {
        if (objetoEjemplo.length > 0) {
            setejemploDatosObtenidos(objetoEjemplo);
        }
    }, [objetoEjemplo]);
            ...
            <div className="contenedorPrincipal">
                <div className="contenedorSecundario">
                    <div className="contenedorPublicaciones" style={{ display: vistaPublicaciones }}>
                        ...
                        <div className="contenedorPublicacionesTabla">
                        {ejemploDatosObtenidos.map((mapeado) => (
                                        <div key={mapeado.id} className="recuadroDeRecibo">
                      ...
                      fecha:{" "}
                      {new Date(mapeado.timestamp.seconds * 1000).toLocaleDateString("es-ES", {
                    //weekday: "long",
                    day: "numeric",
                    month: "long",
                    year: "numeric",
                    ...
                    <span className="textoNombreClienteRecibo">
                      hora:{" "}
                      {new Date(mapeado.timestamp.seconds * 1000).toLocaleTimeString("es-ES", {
                    hour: "numeric",
                    minute: "numeric",
                })}
                    </span>
