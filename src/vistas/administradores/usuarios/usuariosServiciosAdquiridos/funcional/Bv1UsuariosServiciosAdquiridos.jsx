...
// Se reemplaza por que no se va tipoDeCampo que un dato dinamico
const UsuariosServiciosAdquiridos = ({ criterioBusqueda, tipoDeCampo }) => {
  ...
  //console.log(tipoDeCampo, "tipoDeCampo");
      ...
      <div className="alineacionVertical" style={{ display: `${vistaEditor}` }}>
        ...
        <form>
          <div className="alineacionVertical">
            ...
            <div className="marginEdicionUsuariosServiciosAdquiridos">
              <div className="alineacionHorizontalJustificada">
...
export default UsuariosServiciosAdquiridos;
