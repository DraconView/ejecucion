// FILTRA LA COLECCION Y REDERIZA SOLO EL ITEM DETALLADO => ItemDetail
...
const ItemDetailContainer = () => {
    //console.log('llamando a ItemDetailContainer');
...
// itemsbdProductos
    useEffect(() => {
        ...
        const docRef = db.collection("bdProductos").doc(productId)
