...
//        onClick={handleClick}
    ...
    const handleShare = async () => {
        ...
        if (navigator.canShare && navigator.canShare({ files: filesArray })) {
                const whatsappURL = `https://api.whatsapp.com/send?phone=573163782780&text=${encodeURIComponent('¡Este es tu Recibo!')}&data=${encodeURIComponent(filesArray)}`;
        ...
        {visibilidad==='ACTIVO' ? 
            <div className='divPricipalItem' >
                ...
                <div 
                    ...
                    style={{ display:`${vistaDescripcionActiva}`, justifyjjcontent:'space-between' }}
                ...
                <div className='divInactivoTextoDescripcionProducto'
                    style={{ display:`${vistaDescripcionInactiva}`, justifyjjcontent:'space-between' }}
