...
import CrearCategorias from "../../../../vistas/administradores/productos/categoriasProductos/CrearCategoriasProductos";
...
function UserCrearCategorias() {
  ...
  return (
    <div className="app">
      ...
      {user?.displayName ? (
        <CrearCategorias username={user.displayName} />
      ) : (
        <h3
...
export default UserCrearCategorias;
