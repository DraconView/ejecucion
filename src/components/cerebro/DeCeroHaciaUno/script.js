...
const trainingData = [
  ...
  {
    input:
      "¡La Semana de la Moda es muy divertida en el #KimKardashianGame! ¡Me encantaría ver lo que llevas puesto! http://smarturl.it/PlayKKH",
    output: { kardashian: 1 }
  },
  {
    input:
...
function execute(input) {
  ...
  results.trump > results.kardashian
    ? (output = "Trump")
    : (output = "Kardashian"); //codigo Emac6
  return output;
}
...
train(trainingData);
console.log(execute("ellos son de un partido liberal"));
