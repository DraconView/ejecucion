...
const ItemDetail = ({ item }) => {
  ...
  const { productsAdd, providerBdOrdenes } = useContext(CartContext);
  const [imagesArray, setImagesArray] = useState([]);
  const [descuento, setdescuento] = useState("");
  //const [BdOrdenesSeleccionada, setBdOrdenesSeleccionada] = useState("OrdenesProductos");
    ...
    <div className="divPrincipalItemDetail">
      ...
      <div className="divDatosOpcionesProducto">
        <div className="divDatosProductosDetalle">
          ...
          <div className="textoDetalleProductos">
...
/* ItemDetail con descripcion 1209a060223 POSIBLECODIGOFUNCIONAL
            ...
            <div className='divPrincipalItemDetail'>
                ...
                <div className='divDatosOpcionesProducto' >   
                    ...
                    <div className="divDatosProductosDetalle" >
                        ...
                        <div className='textoDetalleProductos' ><span> descripcion: </span> </div>
                        <div className='textoDescripcionDetalleProductos' ><span>{item.descripcion}</span> </div>
                    </div>   
